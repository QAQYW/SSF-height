...
public:
    ...
    // 传感器传输数据所需时间的上下界
    const double MAX_TRANSMISSION_TIME = 10; //10;    // ! 单位是秒还是分钟
    const double MIN_TRANSMISSION_TIME = 0.1; //0.1;   // ! 单位是秒还是分钟
    ...
    // 路径长度与传感器数量的比例系数
    const double MAX_LENGTH_SENSOR_PROP = 20; // 100;
